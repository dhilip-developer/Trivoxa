...
export default function ParticleBackground() {
    ...
    // Don't render anything if WebGL isn't supported or there's an error - prevents black screen
    if (!webglSupported || hasError) {
        return null;
    }

    // Canvas with transparent background - no bg-black!
    return <canvas ref={canvasRef} className="fixed inset-0 z-[-1] pointer-events-none" style={{ background: 'transparent' }} />;
}
